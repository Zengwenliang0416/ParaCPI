...
def main():
    ...
    parser.add_argument('--dataset', default='BindingDB', help='GPCR or Kinase') #required=True,
    ...
    for i in range(num_iter):
        for data in train_loader:
            ...
            if global_step % steps_per_epoch == 0:
                ...
                msg = "epoch-%d, loss-%.3f, test_acc-%.3f, test_pre-%.3f, test_rec-%.3f, test_auc-%.3f, test_roc-%.3f" % (global_epoch, test_loss, test_acc, test_pre, test_rec, test_auc,test_roc)
                logger.info(msg)
